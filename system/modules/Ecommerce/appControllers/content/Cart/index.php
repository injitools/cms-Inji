                        ...
                        <div class="order_page-details">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered order_page-cartItems">
                                    ...
                                    foreach ($cart->cartItems as $cartItem) {
                                        ...
                                        ?>
                                        <tr class="cart_item_id<?= $cartItem->id; ?> item"
                                            data-cart_item_id='<?php echo $cartItem->id; ?>'
                                            ...
                                            <td class="text-right actions">
                                                <div class="btn-group-vertical" role="group" aria-label="...">
                                                    <a type="button" class="btn btn-primary btn-update btn-sm"
                                                       onclick="inji.Ecommerce.Cart.calcSum();"><i
                                                                class="glyphicon glyphicon-refresh"></i></a>
                                                    <a type="button" class="btn btn-danger  btn-delete btn-sm"
                                                       onclick="inji.Ecommerce.Cart.delItem(<?php echo $cartItem->id; ?>);"><i
                                    ...
                                    if ($cart->delivery) {
                                        ...
                                        <tr class="order_page-deliverySum">
                                            <td colspan="<?= $colspan; ?>"
                                                class="text-right"><?= $cart->delivery->name; ?>:
                                            </td>
                            ...
                            <div class="order_page-finish">
                                ...
                                <div class="order_page-orderBtn">
                                    <button name="action" value="order" data-loading-text="Подождите.."
                                            class="btn btn-primary">Подтверждение заказа
                                    </button>
                                </div>
                            </div>
                        </div>
